            ...
            <div className="container mx-auto px-8">
                <div className="flex flex-wrap ">
                    <div className="w-full">
                        <img src="/src/assets/ck.jpg" alt="ck" className="w-full h-96 object-cover mb-2  " />
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mt-5 mb-5">CK Convention Centre</h1>
                        ...
                        <p className="text-black-700 mt-5 ">5/5 (135 Review)</p>
                        <p className="text-red-600 mt-3 mb-5">Rp.359,000</p>
                        <hr className="bg-gray-300 h-[3px] mb-3"/>
                        <div className="w-1/2">
        ...
        />
                        ...
                        <div className="container mx-auto px-12 mt-3 mb-5">
                            ...
                            <div className="flex flex-col gap-3 mb-6">
                                ...
                                <p className="text-md font-semibold mb-1 text-gray-900">ckhotel_</p> 
                                </div>
                                ...
                                <p className="text-md font-semibold mb-1 text-gray-900">0771-1123-3344</p>
                                </div>
                            </div>
                            </div>
                        </div>
