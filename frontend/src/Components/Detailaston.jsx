            ...
            <div className="container mx-auto px-8">
                <div className="flex flex-wrap ">
                    <div className="w-full">
                        <img src="/src/assets/aston.jpg" alt="aston" className="w-full h-96 object-cover mb-2  " />
                        ...
                        <p className="border-2 border-gray-300 w-[60px] rounded-sm text-center font-semibold text-sm py-1 mb-2">Hotel</p>
                        <h1 className="text-3xl font-bold text-gray-900 mt-5 mb-5">Hotel Aston</h1>
                        ...
                        <p className="text-black-700 mt-5 ">5/5 (155 Review)</p>
                        <p className="text-red-600 mt-3 mb-5">Rp.279,000</p>
                        <hr className="bg-gray-300 h-[3px] mb-3"/>
                        <div className="w-1/2">
                        ...
                        <div className="relative" style={{ width: "50%", height: "300px" }}>
                        <iframe
                        title="Google Maps"
                        src="https://maps.app.goo.gl/iFzPCNiUXQsyQYu97"
                        width="100%"
                        height="100%"
                        frameBorder="0"
        ...
        />
                        ...
                        <div className="container mx-auto px-12 mt-3 mb-5">
                            ...
                            <div className="flex flex-col gap-3 mb-6">
                                ...
                                <p className="text-md font-semibold mb-1 text-gray-900">aston_hotel</p> 
                                </div>
                                ...
                                <p className="text-md font-semibold mb-1 text-gray-900">0771-2928-9910</p>
                                </div>
                            </div>
                            </div>
                        </div>
