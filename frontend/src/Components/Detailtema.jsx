        ...
        <div>
            ...
            ></img>
                ...
                <div className="flex justify-end items-center space-x-1 mt-5 ml-3">
                        <img src='../src/assets/account.png' alt="search" className="w-12 h-12"></img>
      </div>
            </div>
            ...
            <div className="container mx-auto px-8">
                <div className="flex flex-wrap ">
                    <div className="w-full">
                        <img src="/src/assets/tema.jpg" alt="Tema Coffee & Space" className="w-full h-96 object-cover mb-2  " />
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mt-5 mb-5">Tema Coffee & Space</h1>
                        <div className="flex justify-left items-center space-x-1">
                        <img src='../src/assets/star.png's alt="stars" className="w-5 h-5"></img>
                        ...
                        <p className="text-black-700 mt-5 ">4/5 (151 Review)</p>
                        <p className="text-red-600 mt-3 mb-5">Rp.159,000</p>
                        <hr className="bg-gray-300 h-[3px] mb-3"/>
                        <div className="w-1/2">
